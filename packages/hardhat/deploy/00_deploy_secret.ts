 ...
 */
const deploySecret: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  console.log("Secret Contract:", secret.address);
};

export default deploySecret;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags Secret
deploySecret.tags = ["Secret"];
